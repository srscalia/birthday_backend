...
10.times do
  ...
  User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.free_email, password: pass, password_confirmation: pass, phone: phone_numbers.sample)
end
